...
import subTerritory.subStateKnife as subStateKnife
import subTerritory.subStateKnifeCL as subStateKnifeCL
import subTerritory.subStateKnifeCLKnife as subStateKnifeCLKnife
...
class CTabStateTerritory(tabState.CTabState) :
    def __init__(self, mediator):
        ...
        self.m_state = 0
        self.m_listSubState = []
        self.m_listSubState.append(subStateKnifeCL.CSubStateKnifeCL(self))
        self.m_listSubState.append(subStateKnifeCLKnife.CSubStateKnifeCLKnife(self))
    ...
    # protected
    def _get_substate(self, inx : int) -> subStateKnife.CSubStateKnife :
