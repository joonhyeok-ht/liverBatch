...
class CSubStateSkelEdit() :
    ...
    def save_cl(self) :
        ...
        print(f"completed save skeleton : {os.path.dirname(outputFullPath)}")
    ...
    def _getui_branch_range(self) -> int :
        return self.m_mediator.getui_branch_range()
    def _getui_ep_range(self) -> int :
        return self.m_mediator.getui_ep_range()
