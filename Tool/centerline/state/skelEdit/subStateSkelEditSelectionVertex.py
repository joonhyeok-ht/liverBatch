...
class CSelectionVertexStateSelection(CSelectionVertexState) :
    ...
    def clicked_mouse_rb(self, clickX, clickY):
        ...
        #     data.CData.s_vesselType,
        #     data.CData.s_skelTypeCenterline,
        #     CSubStateSkelEditSelectionVertex.s_guideClType,
        #     CSubStateSkelEditSelectionVertex.s_guideEPType,
        #     CSubStateSkelEditSelectionVertex.s_guideRangeType,
        #     CSubStateSkelEditSelectionVertex.s_guideCellType,
        # ]
        ...
        #     selectedEPID = data.CData.get_id_from_key(self.m_mediator.m_selVertexKey)
        ...
        # if selKey != self.m_mediator.m_selVertexKey :
        #     self.m_mediator.m_selVertexKey = selKey
        #     self.m_mediator.set_state(1)
...
class CSubStateSkelEditSelectionVertex(subStateSkelEdit.CSubStateSkelEdit) :
    ...
    def create_guide_key(self, guideColor : np.ndarray) :
        ...
        # branch guide create
        selectedEPID = data.CData.get_id_from_key(self.m_selVertexKey)
        leafCL = skeleton.get_centerline(selectedEPID)
        
        guideVertexKey = data.CData.make_key(CSubStateSkelEditSelectionVertex.s_guideVertexType, 0, 0)
        guideVertexObj = vtkObjGuideVertex.CVTKObjGuideVertex(leafCL, leafCL.get_vertex(self.m_firstSelectedVertexID), self.m_range)
        ...
        guideRangeObj = vtkObjGuideRange.CVTKObjGuideRange(leafCL.get_vertex(self.m_firstSelectedVertexID), self.m_range)
