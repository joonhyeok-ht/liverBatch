...
class CTabStateSkelEditLiver(tabState.CTabState) :
    ...
    def process_init(self) :
        ...
        self._on_tab_changed(self.m_state)
    ...
    def init_ui(self) :
        ...
        layout, self.m_sliderBranchRange, self.m_editBranchRange = self.m_mediator.create_layout_label_slider_editbox("Branch Range", CTabStateSkelEditLiver.s_minRange, CTabStateSkelEditLiver.s_maxRange, 1, True)
    ...
    def __apply_root_point(self) :
        ...
        for clinfoInx in clinfoInxs:
            ...
            key = data.CData.make_key(self.s_rootPointType, clinfoInx, 0)
