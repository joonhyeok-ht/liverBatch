...
class CClipUnderUmbilicusPoly() :
    m_maskSkinName = "Skin"
    m_stlSkinName = "Skin"
    m_maskAbdWallName = "Abdominal_wall_liver"
    m_stlAbdWallName = "Abdominal_wall_liver"
    ...
    def process(self) -> bool:
        ...
        if self.m_inputSliceID > 0:
            ...
            skinMaskPath = os.path.join(self.InputMaskPath, f"{maskName}.nii.gz")
            ...
            abdWallMaskPath = os.path.join(self.InputMaskPath, f"{self.m_maskAbdWallName}.nii.gz")
    ...
    @property
    def InputOptionInfo(self):
        return self.m_inputOptionInfo
    @InputOptionInfo.setter
    def InputOptionInfo(self, inputOptionInfo):
    ...
    @InputPhase.setter
    def InputPhase(self, inputPhase):
        self.m_inputPhase = inputPhase
        
    @property
    def InputMaskPath(self):
        return self.m_inputMaskPath
    @InputMaskPath.setter
    def InputMaskPath(self, inputMaskPath):
