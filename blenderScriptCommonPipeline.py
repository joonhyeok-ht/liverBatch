...
class CBlenderScriptCommonPipeline :
    ...
    def process(self) -> bool :
        ...
        self.m_outputPatientPath = os.path.join(self.m_outputRootPath, self.m_patientID)
        ...
        self._save_blender_with_patientID(self.m_outputPatientPath, self.m_saveAs)
...
if __name__=='__main__' :
    ...
    if "--" in args :
        ...
        if patientID is None or stlPath is None or saveAs is None:
