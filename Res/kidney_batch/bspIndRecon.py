...
class CBSPIndRecon(blenderOption.CBlenderScriptBase) :
    ...
    def process(self) -> bool :
        ...
        # individual에서 Tumor, Cyst는 별도로 지우는 처리를 해야한다. 
        blenderOption.CBlenderScriptUtil.match_mesh_data_name()
        blenderOption.CBlenderScriptUtil.rename_mesh("Tumor_exo", "Tumor")
        blenderOption.CBlenderScriptUtil.rename_mesh("Tumor_endo", "Tumor")
        blenderOption.CBlenderScriptUtil.join_objects("Cyst", "Cyst")
