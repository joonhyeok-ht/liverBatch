...
class CBSMImportObj(blenderOption.CBlenderScriptBase) :
    '''
    param
    ...
    desc 
        - 기존 내용에 추가적으로 obj 파일들을 import 한다. 
    '''
    ...
    def process(self) -> bool :
        ...
        for objFullPath in listObjFullPath :
            objFile = os.path.basename(objFullPath)
...
if __name__=='__main__' :
    ...
    if "--" in args :
        ...
        if optionFullPath is None :
            ...
            inst = CBSMImportObj(optionFullPath)
            inst.process()
